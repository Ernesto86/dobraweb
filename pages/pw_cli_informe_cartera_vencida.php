...
<head>
    ...
    <script language="javascript">
        ...
        function fn_cli_inf_cartera_vencida() {
            if ($('#txt_fech_ini').val() == '') {
            ...
            if ($('#txt_valor_ini').val().trim() == '') {
                alert('Ingrese Rango Inicial');
                $('#txt_valor_ini').focus();
                return;
            }

            if ($('#txt_valor_fin').val().trim() == '') {
                alert('Ingrese Rango Final');
                $('#txt_valor_fin').focus();
                return;
            }
            ...
            $('#contenedor').html('');
            $.ajax({
                url: 'pw_cli_det_informe_cartera_vencida.php',
        ...
        function fn_reporte(tip_rpt) {
            ...
            $('#rpt').val(tip_rpt);
            $('#frm_buscar').attr('action', 'pw_cli_det_informe_cartera_vencida.php');
            $('#frm_buscar').submit();
        }
    </script>
</head>
...
<div id="buscar">
    <div class="relleno">
        <form id="frm_buscar" name="frm_buscar" method="post" action="javascript:fn_cli_inf_cartera_vencida();">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="table_buscar">
                <tr>
                    ...
                    <td class="separador">&nbsp;</td>
                    <td>Abono</td>
                    <td><input name="txt_valor_ini" type="text" id="txt_valor_ini" size="5" maxlength="5" class="dats"/>
                    </td>
                    <td>a</td>
                    <td><input name="txt_valor_fin" type="text" id="txt_valor_fin" size="5" maxlength="5" class="dats"/>
                    </td>
                    <td><input type="submit" name="btn_inf_saldos" id="btn_inf_saldos" value="Cartera Vencida&gt;&gt;"
                               class="green"/></td>
                    <td>
                        <div id="load_img"></div>
                    </td>
