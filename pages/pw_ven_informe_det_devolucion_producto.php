...
require '../clases/cls_ven_devolucion.php';
$obj = new cls_ven_devolucion; ?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="content">
    <div id="det_datos_cliente">
        <div class="cab_title"><?php if ($_POST['rpt'] == 'HTML' or $_POST['rpt'] == 'PDF') { ?>
            ...
            } ?><img src="../images/icon/234 PagesView4.png" height="14" width="14"/> VENTAS - INFORME DE DEVOLUCIONES.
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table_detcliente">
            ...
            <tr>
                ...
                <td width="9%" align="right"><strong>Bodega :</strong></td>
                <td width="28%"><?= $_POST['dtbodega'] ?></td>
    ...
    <div id="dt_data_table">
        <table border="0" cellpadding="0" cellspacing="0" class="dynamic styled with-prev-next"
            ...
            $obj->fn_informe_ventas_devolucion(); ?>
            </tbody>
        </table>
    </div>
    <div id="piepag"></div>
