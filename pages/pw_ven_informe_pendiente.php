...
<head>
    ...
    <script language="javascript">
        ...
        function fn_cli_inf_saldos() {
            if ($('#txt_codigo').val() == '') {
                alert('Seleccione Grupo o Ingrese el Codigo.');
                $('#txt_codigo').focus();
                return;
            }
            if ($('#txt_fech_fin').val() == '') {
            ...
            $('#contenedor').html('');
            $.ajax({
                url: 'pw_ven_det_informe_pendiente.php',
...
<div id="buscar">
    <div class="relleno">
        <form id="frm_buscar" name="frm_buscar" action="javascript:fn_cli_inf_saldos();">
            <table border="0" cellpadding="0" cellspacing="0" id="table_buscar">
                <tr>
                    ...
                    <td class="separador">&nbsp;</td>
                    <td><input type="submit" name="btn_inf_saldos" id="btn_inf_saldos"
                               value="Comisi&oacute;n Pendiente&gt;&gt;" class="green"/></td>
                    <td>&nbsp;</td>
                    <td>
                        <div id="load_img"></div>
                    </td>
                    ...
                    <td><input type="button" name="Submit2" value="Excel" class="report_excel"
