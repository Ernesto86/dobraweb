    ...
    <script language="javascript">
        ...
        $(document).ready(function () {
            ...
            $('#cb_det_factura').change(function () {
                ...
                if (num_fact == '' || num_fact.length < 1) stopPropagation();
            ...
            $("#btn_guardar").click(function () {
                ...
                if (parseFloat($('#txt_total_devol').val()) <= 0) {
                ...
                try {
                    ...
                    $.ajax({
                        url: 'pw_guardar_devolucion_venta.php',
                        ...
                        success: function (resp) {
                            ...
                            switch (resp.err) {
                                ...
                                case'7':
                                    alert('Error: No se Pudo Crear los ID de CRUCE DE VALORES.');
                                    break;
            ...
            $('#btn_aplicar_deuda').click(function () {
                ...
                var total_cred = parseFloat($('#txt_total_devol').val());
        ...
        function fn_buscar_cliente() {
            ...
            if ($('#txt_cli_codigo').val().length < 1 || $('#txt_cli_codigo').val().trim() == '') {
                alert('Ingrese el C�digo del Cliente.');
                $('#txt_cli_codigo').val('');
                $('#txt_cli_codigo').focus();
                return;
            }
...
<div id="contenedor" align="center">
    <div id="form_transaccion">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table_contenedor">
            <tr>
                <td class="bg_cab_title"><img src="../images/icon/Grid.png"/> Datos Devolucion de Ventas.
                    <div class="rigth"></div>
                </td>
            </tr>
            <tr>
                            ...
                            <td width="78%">
                                <table border="0" cellpadding="0" cellspacing="0" class="styletable">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="txt_tipo" type="text" id="txt_tipo" value="VEN-DE" size="10"
                        ...
                        <tr>
                            <td>
                                <table border="0" align="right" cellpadding="0" cellspacing="0" class="styletable">
                                    <tr>
                                        <td>TOTAL DEVOLUCION:</td>
                                        <td><input name="txt_total_devol" type="text" class="total_fact datos"
                                                   id="txt_total_devol" value="0.00" size="8"/></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                            </td>
