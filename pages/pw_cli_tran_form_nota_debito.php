...
<div id="contenedor" align="center">
    <div id="form_transaccion">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table_contenedor">
            <tr>
                <td class="bg_cab_title"><img src="../images/icon/Grid.png"/> Datos Nota de Debito.
                    <div class="rigth"></div>
                </td>
            </tr>
            <tr>
                            ...
                            <td width="78%">
                                <table border="0" cellpadding="0" cellspacing="0" class="styletable">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="txt_tipo" type="text" id="txt_tipo" value="CLI-DB" size="10"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="7"><input name="txt_cli_concepto" type="text" id="txt_cli_concepto"
                                                               size="90" maxlength="70" class="datos"/></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td align="right">&nbsp;</td>
                                        ...
                                        <td colspan="6"><input name="txt_cli_nombre" type="text" id="txt_cli_nombre"
                                                               size="55" maxlength="50" readonly="" class="negrita"/>
                                ...
                                <div class="inv_tabledetalle">
                                    <table border="0" cellpadding="0" cellspacing="0" class="styletable_detalle"
                                        ...
                                        <tr>
                                            ...
                                            <th width="38px">Fecha</th>
                                            <th width="38px">F.Vence</th>
                                            <th width="220px">Detalle</th>
                                            <th width="28px">Valor</th>
                                            <th width="28px">Total</th>
                                        </tr>
                                        </thead>
                                        <tbody id="det">
                                        </tbody>
                    ...
                    <div class="relleno">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="styletable">
                            <tr>
                                ...
                                <td width="91%">
                                    <input name="txt_nota" type="text" class="datos" id="txt_nota" size="110"
                                           maxlength="70"/>
                                </td>
                            </tr>
                        </table>
