...
<head>
    ...
    <script language="javascript">
        ...
        function fn_cli_inf_call_center() {
            ...
            $.ajax({
                url: 'pw_inv_det_informe_productos_facturados.php',
        ...
        function fn_report_html(tip_rpt) {
            ...
            $('#rpt').val(tip_rpt);
            $('#frm_buscar').attr('action', 'pw_inv_det_informe_productos_facturados.php');
            $('#frm_buscar').submit();
        }
    </script>
</head>
        ...
        <form id="frm_buscar" name="frm_buscar" method="post" action="javascript:fn_cli_inf_call_center();">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="table_buscar">
                <tr>
                    ...
                    <td><input name="txt_codigo" type="text" id="txt_codigo" size="7" class="dats txt-codigo"/></td>
                    <td>
                    ...
                    <td><input name="txt_fech_fin" type="text" id="txt_fech_fin" value="<?= date('d/m/Y'); ?>" size="9"
                               class="fecha dats"/></td>
                    <td class="separador"><select name="cb_producto" id="cb_producto" style="width:150px" class="dats">
