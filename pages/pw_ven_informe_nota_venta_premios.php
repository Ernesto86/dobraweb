...
<head>
    ...
    <script language="javascript">
        ...
        function fn_cli_inf_nota_venta_premio() {
            ...
            $.ajax({
                url: 'pw_ven_det_informe_nota_venta_premios.php',
        ...
        function fn_reporte(tip_rpt) {
            ...
            $('#rpt').val(tip_rpt);
            $('#frm_buscar').attr('action', 'pw_ven_det_informe_nota_venta_premios.php');
            $('#frm_buscar').submit();
        }
    </script>
</head>
        ...
        <form id="frm_buscar" name="frm_buscar" method="post" action="javascript:fn_cli_inf_nota_venta_premio();">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="table_buscar">
                <tr>
                    ...
                    <td><input type="submit" name="btn_premios" id="btn_premios" value="Premios&gt;&gt;" class="green"/>
                    </td>
                    <td>
                        <div id="load_img"></div>
                    </td>
