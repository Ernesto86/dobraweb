...
<head>
    ...
    <script language="javascript">
        ...
        function fn_cli_inf_saldos() {
            ...
            $('#contenedor').html('');
            $.ajax({
                url: 'pw_ven_det_informe_factura.php',
        ...
        function fn_report_html(tip_rpt) {
            ...
            $('#rpt').val(tip_rpt);
            $('#frm_buscar').attr('action', 'pw_ven_det_informe_factura.php');
            $('#frm_buscar').submit();
        }
    </script>
</head>
        ...
        <form id="frm_buscar" name="frm_buscar" method="post" action="javascript:fn_cli_inf_saldos();">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="table_buscar">
                <tr>
                    ...
                    <td class="separador">&nbsp;</td>
                    <td><input type="submit" name="btn_inf_saldos" id="btn_inf_saldos" value="Ventas Facturas&gt;&gt;"
                               class="green"/></td>
                    <td>&nbsp;</td>
                    <td>
                        <div id="load_img"></div>
